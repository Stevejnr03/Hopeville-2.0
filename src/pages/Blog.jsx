...
const categories = ["All", "Eye Health", "Eyewear", "Health", "Pediatric", "Digital Health", "Nutrition"];
      ...
      {featured && (
        <section className="bg-white py-16 md:py-20 border-b border-[#e8e8e8]">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <p className="text-[#B5685A] text-xs tracking-[0.35em] uppercase mb-8"
              style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Featured Post
            </p>
            <Link to={`/blog/${featured.slug}`} className="group grid md:grid-cols-2 gap-10 md:gap-16 items-center">
              {/* Image */}
              ...
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-light text-[#1a1a1a] leading-tight mb-5 group-hover:text-[#4A7E96] transition-colors duration-300"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  {featured.title}
                </h2>
                ...
                <div className="flex items-center gap-2 text-[#4A7E96] text-sm tracking-[0.1em] uppercase font-medium group-hover:text-[#B5685A] transition-colors duration-200"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  Read Article
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col divide-y divide-[#e8e8e8]">
          {filtered.map((blog, index) => (
            <Link
              ...
              <div>
                ...
                <h2 className="text-2xl md:text-3xl font-light text-[#1a1a1a] leading-tight mb-4 group-hover:text-[#4A7E96] transition-colors duration-300"
                  style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  {blog.title}
                </h2>
                <p className="text-[#666] text-base leading-relaxed font-light mb-8">
          ...
          {filtered.length === 0 && (
            <div className="text-center py-20">
              <p className="text-[#888] text-lg">No posts in this category yet.</p>
