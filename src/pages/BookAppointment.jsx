            ...
            <div className="bg-white border border-[#e8e8e8] p-8 md:p-12">
              {submitted ? (
                <div className="text-center py-16">
                  ...
                  <h3
                    className="text-3xl font-light text-[#1a1a1a] mb-3"
                    style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  >
                  ...
                  <p className="text-[#666] text-base font-light mb-2 max-w-md mx-auto">
                    ...
                    received your appointment request and will confirm your
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div>
                    <h3
                      className="text-lg font-medium text-[#1a1a1a] mb-5 pb-3 border-b border-[#e8e8e8]"
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        {user ? (
                          <div className="w-full border border-[#e8e8e8] px-4 py-3 text-sm text-[#1a1a1a] bg-[#f8f8f6] cursor-not-allowed">
                            {formData.firstName}
                          </div>
                        ) : (
                          <input
                            ...
                            required
                            placeholder="John"
                            className="w-full border border-[#e8e8e8] px-4 py-3 text-sm focus:outline-none focus:border-[#4A7E96] transition-colors"
                          />
                        )}
                      </div>
                      <div>
                  ...
                  {/* Create account — HIDDEN when logged in */}
                  {!user && (
                    <div className="border border-[#e8e8e8] p-5 mt-4">
                      <label className="flex items-start gap-3 cursor-pointer group">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#888] mt-1">
                            Track your appointment history and book faster next
                            time
                          </p>
                        </div>
                      </label>
                  ...
                  <div className="bg-[#4A7E96]/5 border border-[#4A7E96]/20 px-6 py-4 flex items-start gap-3">
                    ...
                    <p className="text-[#555] text-xs leading-relaxed">
                      ...
                      Hopeville Eye Clinic to confirm your appointment. We will
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center max-w-5xl mx-auto">
            ...
            <div>
              ...
              <p className="text-[#555] text-base leading-relaxed font-light mb-6">
                Dr. Ezinne Ihekweaba is the driving force behind Hopeville Eye
                Clinic's commitment to excellence. As Medical Director and
                Consultant Optometrist, she brings years of specialized
                expertise in comprehensive eye care, combining clinical
                precision with a deeply personal approach to patient wellbeing.
              </p>
              <p className="text-[#555] text-base leading-relaxed font-light mb-8">
                Under her leadership, Hopeville Eye Clinic has grown into Port
                Harcourt's most trusted destination for both clinical eye care
                and luxury optical services — a testament to her vision for what
                modern eye care should look like.
              </p>
